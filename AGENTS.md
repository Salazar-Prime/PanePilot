...
61. LaTeX source highlighting follows TeX control-symbol escaping: `\%` is a literal percent sign and does not comment out the remainder of its line, while an unescaped `%` does. Consecutive backslashes retain their odd/even escaping semantics.
